...
//  text = text.replace(/((^ {0,3}>[ \t]?.+?(\{: +(\w+)\})?\n(.+\n)*\n*)+)/gm, function (wholeMatch, m1, m2, m3, m4, m5, m6) {
    text = text.replace(/((^ {0,3}>[ \t]?.+?(\{: +(\w+)\})?\n)(^ {0,3}>[ \t]?.*?\n)*)/gm, function (wholeMatch, m1, m2, m3, m4, m5, m6) {
        ...
        var blockQuoteClassNameMarker = m3;
        var blockQuoteClassName = m4;
        var classNameRegEx = new RegExp(blockQuoteClassNameMarker, "g");
        bq = bq.replace(classNameRegEx, "");
        ...
        return showdown.subParser('hashBlock')('<blockquote class="' + blockQuoteClassName + '">\n' + bq + '\n</blockquote>', options, globals);
  });
